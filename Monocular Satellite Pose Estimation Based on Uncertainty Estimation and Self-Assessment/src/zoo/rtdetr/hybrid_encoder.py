...
class HybridEncoder(nn.Module):
    def __init__(
        ...
        self.encoder_fusion_input = nn.Conv2d(
        ...
        for _ in range(len(in_channels) - 1, 0, -1):
            ...
            self.fpn_blocks.append(
                # nn.Conv2d(hidden_dim * 2, hidden_dim, 1, 1, 0)
                CSPRepLayer(
                    hidden_dim * 2,
                    hidden_dim,
                    1,
        ...
        # self.conv_encoder = nn.Conv2d(256, 256, 1, 1)
    ...
    def forward(self, feats):
        ...
        # proj_feats[0].shape bs C 32 32 proj_feats[1].shape bs C 16 16 proj_feats[2].shape bs C 8 8
